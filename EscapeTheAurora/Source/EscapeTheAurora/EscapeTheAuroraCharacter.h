...
#include "EscapeTheAuroraCharacter.generated.h"

class UInputComponent;

UCLASS(config=Game)
class AEscapeTheAuroraCharacter : public ACharacter
{
	GENERATED_BODY()
...
public:
	...
	TSubclassOf<class AEscapeTheAuroraProjectile> ProjectileClass;
